...
module neural_network(
    ...
    $display("time=%0t pool_en=%b fin_pool=%b pool_in1=%0d pool_in2=%0d pool_in3=%0d pool_in4=%0d,pool_in4_addr=%0d", 
              $time, pool_enable, finished_pool, pool_in1,pool_in2,pool_in3,pool_in4,pool_in4_addr);
end*/
   ...
   /* always @(posedge clk) begin
    $display("time=%0t pool_en=%b fin_pool=%b dense1_enable=%0b, finished_dense1=%0b", 
              $time, pool_enable, finished_pool,dense1_enable,finished_dense1);
end*/
   ...
   /* always @(posedge clk) begin
    $display("time=%0t pool_en=%b fin_pool=%b finished_dense1=%0b dense2_enable=%0b finished_dense2=%0b", 
              $time, pool_enable, finished_pool,finished_dense1,dense2_enable, finished_dense2);
end*/
    ...
    /*always @(posedge clk) begin
    $display("time=%0t pool_en=%b fin_pool=%b fin_dense1=%b fin_dense2=%b NN_done=%b", 
              $time, pool_enable, finished_pool, finished_dense1, finished_dense2, NN_done);
end*/
 /*always @(posedge clk) begin
      $display("in_data=%p",dense2_res);
end*/
